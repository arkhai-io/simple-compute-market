...
See [site capacity](../../openspec/specs/site-capacity/spec.md) and [physical provisioning](../../openspec/specs/physical-provisioning/spec.md) for the contracts behind these terms.
