...
| Named items resolve through mutable module-level registries populated by import order, so a role cannot state which names it may resolve | [`kit-storefront-composition-seam`](../../openspec/changes/kit-storefront-composition-seam/) |
