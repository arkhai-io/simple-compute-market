...
| Bare-metal publication reads no pool declaration, does not converge its registry, and does not use the kit publication runtime | [`bare-metal-publication-reads-pool-declarations`](../../openspec/changes/bare-metal-publication-reads-pool-declarations/) |
