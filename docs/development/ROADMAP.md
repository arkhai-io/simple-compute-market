...
| An unbacked compute listing has no settlement option to publish, because introduction is not composed for compute | [`compose-contact-exchange-across-compute`](../../openspec/changes/compose-contact-exchange-across-compute/) |
| Bare-metal publication reads no pool declaration and does not converge its registry | [`bare-metal-publication-reads-pool-declarations`](../../openspec/changes/bare-metal-publication-reads-pool-declarations/) |
