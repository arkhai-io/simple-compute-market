...
4. Is the code organized according to the layering definitions in ARCHITECTURE.md. Is universal market behavior located in core? Is reusable inter-market functionality located at the kit layer? Does the domain layer correctly compose that functionality rather than encode it?