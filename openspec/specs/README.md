...
| Contact-exchange settlement | [Spec](contact-exchange-settlement/spec.md) | [Architecture](contact-exchange-settlement/architecture.md) |
...
| Introduction delivery | [Spec](introduction-delivery/spec.md) | [Architecture](introduction-delivery/architecture.md) |
