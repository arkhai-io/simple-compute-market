...
- The domain settlement identity carried alongside the engine's neutral claim reference, and the mechanisms it is withheld for: `domains/vms/storefront/tests/unit/test_claims_stage_event_identity.py`.
