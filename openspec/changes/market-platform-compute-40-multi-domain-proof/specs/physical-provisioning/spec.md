...
One extracted compute provisioner MUST load VM and bare-metal adapter bundles concurrently and dispatch action and release behavior from the committed allocation's executor identity.
