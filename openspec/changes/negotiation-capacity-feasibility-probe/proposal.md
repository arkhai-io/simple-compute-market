...
calls it during negotiation, which runs as `kit/negotiation-runtime`'s lifecycle
with the VM domain's hooks injected.
...
- Affected code: `kit/negotiation-runtime`'s
