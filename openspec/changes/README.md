...
bare-metal-publication-reads-pool-declarations (complete) ──► bare-metal-listing-shapes ──► unbacked-bare-metal-listings
bare-metal-publication-reads-pool-declarations (complete) ──► bare-metal-mock-provisioned-deal
...
through it: `bare-metal-publication-reads-pool-declarations` (complete), then
