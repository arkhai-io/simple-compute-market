...
- [ ] 2.1 Render the per-lease socket, SSH service template, slice, generated runtime view and lease SSH daemon configuration from the access role. Unit-test the rendered directives and the absence of host-account creation.
