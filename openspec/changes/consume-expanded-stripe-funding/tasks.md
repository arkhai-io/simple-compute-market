...
- [x] 6.4 Add storefront/buyer profile-store and settlement database migrations plus fixtures for new safe fields and recovery-only legacy card classification, preserving historical option/obligation/settlement/operation/request/receipt identities and rolling back ambiguous rows atomically.
