...
- [ ] 11.8 **Documentation citations.** Run
      `make check-doc-citations CHANGE=relay-vm-access-without-a-dashboard` and resolve every match.
      ...
      rename-to-tombstone.
- [ ] 11.9 **End-to-end pipeline.** Confirm the end-to-end pipeline passes and
