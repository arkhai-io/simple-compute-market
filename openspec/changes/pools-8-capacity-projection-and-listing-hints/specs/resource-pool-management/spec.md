...
A Resource Pool management surface that accepts `max_reservation_hold_seconds` MUST require a nonnegative integer and MUST expose the normalized value as advisory metadata rather than an admission rule.
