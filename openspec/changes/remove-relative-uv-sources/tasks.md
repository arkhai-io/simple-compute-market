...
- [x] 5.1 Closeout passed comment hygiene, touched-path tests, clean wheel
      ...
      roadmap impact.
- [ ] 5.2 **Campaign index currency** (part seven, added when
      ...
      both unchanged.
- [ ] 5.3 **Documentation citations.** Run
      `make check-doc-citations CHANGE=remove-relative-uv-sources` and resolve every match.
      ...
      rename-to-tombstone.
- [ ] 5.4 **End-to-end pipeline.** Confirm the end-to-end pipeline passes and
