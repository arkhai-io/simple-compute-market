...
def materialization_to_lease_create(
    ...
    *,
    ...
    # setdefault, not assignment: a caller-supplied name is kept so the
    # executing authority sees it and refuses it, rather than having an
    # attempted override silently replaced here.
