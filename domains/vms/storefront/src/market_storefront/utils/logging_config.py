...
def setup_file_logging(
    log_file_path: str | None = None, log_level: str = "INFO"
) -> None:
    ...
    if is_cloud_run():
        ...
        logging.info(
            f"Logging configured for Cloud Run: stdout/stderr (captured by Cloud Logging), level={log_level}"
        )
    else:
        ...
        if log_file_path is None:
            ...
            safe_agent_id = "".join(
                c if c.isalnum() or c == "_" else "_" for c in agent_id
            )
