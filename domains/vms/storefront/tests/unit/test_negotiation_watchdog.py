...
def _init_threads_table(db_path: str) -> None:
    ...
    SQLiteClient(db_path=db_path, registry=build_vm_storefront_registry(build_vm_storefront_domain()))
...
async def test_stale_active_thread_is_abandoned(tmp_path):
    ...
    client = SQLiteClient(db_path=db_path, registry=build_vm_storefront_registry(build_vm_storefront_domain()))
