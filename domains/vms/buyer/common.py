...
# Registry discovery configuration is schema-invariant and moved into the
# core buyer role; re-exported here because every CLI module resolves it
# through `.common`.
from core_buyer.registry_config import (  # noqa: E402,F401
