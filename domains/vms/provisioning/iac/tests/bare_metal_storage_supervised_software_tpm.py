...
_PREPARATION_REFUSAL_CODES = {
    ...
    "custody and custody factory are mutually exclusive": "custody-source-ambiguous",
    "ESAPI ownership boundary could not be opened": "esapi-boundary-open-failed",
    "activation ownership evidence is unsafe": "activation-evidence-unsafe",
    "activation ownership identity is ambiguous": "activation-identity-ambiguous",
    "activation ownership is incomplete": "activation-incomplete",
    "activation ownership state is invalid": "activation-state-invalid",
    "lease storage is already activated": "activation-already-completed",
    "backing provenance is malformed": "backing-provenance-malformed",
    "backing provenance request identity changed": "backing-provenance-request-mismatch",
    "backing provenance is not safely owned": "backing-provenance-unsafe",
    "backing provenance no longer matches": "backing-provenance-mismatch",
    "cannot verify LUKS2 backing provenance": "backing-provenance-unverifiable",
    "lease storage is not durably prepared": "prepared-state-missing",
    "prepared receipt identity no longer matches": "prepared-receipt-identity-mismatch",
    "legacy preparation has no activation provenance": "activation-provenance-missing",
    "preparation identity does not match activation": "preparation-identity-mismatch",
    "preparation request identity changed across retry": "preparation-request-identity-changed",
    "prepared counter no longer matches": "prepared-counter-mismatch",
    "prepared lease lock is no longer held": "prepared-lock-released",
    "prepared sealed-object Name changed": "prepared-object-name-changed",
    "prepared sealed-object Name is invalid": "prepared-object-name-invalid",
    "recorded sealed-object Name is malformed": "recorded-object-name-malformed",
}
