# arkhai-apicredits-middleware (Rust)

Seller-side gating middleware for the API-credits domain — the Rust
...
stands up an in-process scripted credits service with `axum`, and the
