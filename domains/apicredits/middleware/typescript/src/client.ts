/**
 * Client for the credits service's middleware-facing surface.
 *
...
/**
 * The slice of the credits service the gate depends on. `TokensClient`
...
/**
 * Calls the credits service for one gated app. Pass a custom `fetchFn`
