...
os.environ.setdefault("APICREDITS_STOREFRONT_ENABLE_REGISTRY_DISCOVERY", "false")
os.environ.setdefault("APICREDITS_STOREFRONT_DB_PATH", "/tmp/apicredits-storefront-test.db")
