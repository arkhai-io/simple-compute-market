"""API-credits buyer-side negotiation middlewares.

``answer_key_challenge`` is the buyer mirror of the seller's planned
``key_possession_challenge`` middleware (ARCHITECTURE.md, "API-credits
...
This ships in the API-credits buyer's default chain from day one as a
