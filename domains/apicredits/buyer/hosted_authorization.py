"""API-credit composition seam for exact accepted hosted authorization."""
...
async def prepare_hosted_funding_authorization_async(
    *,
    ...
    """Authorize one accepted API-credit obligation immediately before start."""
...
def prepare_hosted_funding_authorization(**kwargs: Any) -> FundingAuthorizationReceipt:
    """Synchronous command wrapper around the async authorization call."""
