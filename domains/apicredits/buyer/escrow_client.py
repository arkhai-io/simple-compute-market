"""API-credits-owned Alkahest escrow materialization and submission adapters."""
...
def encode_escrow_proposal(proposal: Any) -> dict[str, Any]:
    """Encode the API-credit Alkahest proposal without changing its HTTP shape."""
...
def make_alkahest_settlement_payload_fn(
    *,
    ...
    """Build the API-credit-owned EVM settlement request encoder."""
...
def make_create_escrow_fn(
    *,
    ...
    """Build the Alkahest submission hook used by API-credit composition."""
