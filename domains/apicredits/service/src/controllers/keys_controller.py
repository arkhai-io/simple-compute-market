    ...
    def issue(
        ...
        try:
            result = service.issue(
                ...
                buyer_scheme=body.buyer.scheme.value if body.buyer else None,
                buyer_id=body.buyer.identifier if body.buyer else None,
                owner_scheme=body.owner.scheme.value if body.owner else None,
                owner_id=body.owner.identifier if body.owner else None,
