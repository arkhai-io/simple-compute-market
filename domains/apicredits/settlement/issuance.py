"""Credits-service issuance client.

The storefront's settlement job talks to the credits service
(``arkhai-apicredits-service``) over its admin-gated HTTP surface:
