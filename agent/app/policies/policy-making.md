...
For programmatic composite creation, use utilities from `core.agent.app.policy.composite`:

```python
from core.agent.app.policy.composite import build_composite_callable
