...
output "installer_files_storage_bucket_name" {
  value       = module.installer_files_storage.bucket_name
  description = "The name of the GCS bucket for installer files."
}

output "installer_files_storage_bucket_url" {
  value       = module.installer_files_storage.bucket_url
  description = "The URL of the GCS bucket for installer files."
}

output "installer_files_storage_sa_json" {
  value       = module.installer_files_storage_rsa.service_account_key_json
  description = "The JSON key of the service account for installer files storage."
  sensitive   = true
}
