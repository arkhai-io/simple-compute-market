"""Alkahest-scalar negotiation middlewares.
...
Importing this module registers the middlewares (``bisection``,
``listed_price``, the escrow-shape guards, the per-kind dispatch), the
same way domain modules register theirs. ``market_alkahest`` is a lazy
