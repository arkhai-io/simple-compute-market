...
test: test-core test-kits test-compute-provisioning test-provisioning test-provisioning-iac test-registry test-storefront test-bare-metal test-vms-domain test-vms-buyer test-apicredits
