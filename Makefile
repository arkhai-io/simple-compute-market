...
build-seller: init-prerequisites dist-storefront-client dist-identity dist-core dist-arkhai-core-storefront dist-alkahest dist-config dist-storefront dist-policy dist-provisioning-client dist-provisioning dist-registry ## Build only what a seller needs: storefront + provisioning images.
...
init-storefront: dist-vms-common dist-policy dist-provisioning-client dist-provisioning dist-storefront-client dist-registry
