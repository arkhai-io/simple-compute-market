...
# ---------------------------------------------------------------------------
dist: dist-storefront-client dist-identity dist-core dist-arkhai-core-buyer dist-arkhai-core-storefront dist-kit-site dist-alkahest dist-config dist-bare-metal dist-bare-metal-storefront dist-vms dist-storefront dist-policy dist-provisioning-client dist-apicredits-service dist-apicredits-storefront dist-apicredits-buyer dist-apicredits-middleware dist-apicredits-sample-app dist-registry-client dist-buyer
...
dist-bare-metal-storefront: ## Build arkhai-bare-metal-storefront wheel into .dist/
	-mkdir -p $(DIST_DIR)
	cd domains/bare_metal/storefront && uv build --wheel --out-dir $(DIST_DIR)
...
build-seller: init-prerequisites dist-storefront-client dist-identity dist-core dist-arkhai-core-storefront dist-alkahest dist-config dist-bare-metal dist-bare-metal-storefront dist-storefront dist-policy dist-provisioning-client dist-registry-client ## Build only what a seller needs: storefront + provisioning images.
...
init-storefront: dist-vms dist-bare-metal dist-bare-metal-storefront dist-policy dist-provisioning-client dist-storefront-client dist-registry-client
